...
class StudentRepositoryTest {
  ...
  void getAllStudents_ReturnListWithStudents_whenDbIsNotEmpty() {
    List<Student> expected = Arrays.asList(
        new Student(1, "Chris", "Martin", 1, null),
        new Student(2, "Mari", "Osvald", 2, null));
  ...
  void createStudent_shouldAddNewStudentWithIncrementedIdToDb_whenGetStudent() {
    Student student = new Student(0, "New", "Student", 1, null);
    List<Student> expected = Arrays.asList(
        new Student(1, "Chris", "Martin", 1, null),
        new Student(2, "Mari", "Osvald", 2, null),
        new Student(3, "New", "Student", 1, null));
  ...
  void getStudentById_shouldReturnStudent_whenGetStudentsExistsId() {
    ...
    Student expected = new Student(1, "Chris", "Martin", 1, null);
  ...
  void updateStudentById_shouldUpdateStudent_whenGetExistsStudentIdAndParameters() {
    Student expected = new Student(1, "Updated", "Student", 2, null);
 
    assertEquals(expected, dao.save(new Student(1, "Updated", "Student", 2, null)));
  ...
  void deleteStudentById_shouldDeleteStudent_whenGetExistsStudentId() {
    ...
    assertEquals(Arrays.asList(new Student(1, "Chris", "Martin", 1, null)), students);
  }
